...
export function rehabConditioningTemplate(values, calf, soleus) {
  ...
  return {
    ...
    items: [
      ...
      block(CATALOG.hamstring, "Circuit B · Achilles & movement", {sets:3,reps:"10–15",requestedMovement:"Backward jog",selectionReason:"Low-impact leg work fills this slot. Backward jogging is not added on top of a running exposure."}),
      ...
      block(REHAB_MOVEMENTS["rehab-bodyweight-squat"], "Circuit C · Balance & control", {sets:2,reps:"12",requestedMovement:"Half-BOSU squat",selectionReason:"Stable-floor squat is the starting alternative. The BOSU version requires review of your device orientation and balance setup; it is not unlocked by ownership."}),
