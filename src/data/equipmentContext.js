...
export const EQUIPMENT_REFERENCE_EXERCISES = [
 ...
 ["sled-push","Sled push","training-sled","Purpose-built training sled with a suitable push interface. Exact setup and demonstration remain under review."],
 ["forward-sled-drag","Forward sled drag / resisted march","training-sled","Purpose-built training sled with a suitable pulling attachment. Exact setup and demonstration remain under review."],
...
].map(([id,name,equipment,setup])=>({id,name,equipment:[equipment],muscle:"Conditioning",setup,review:"Reference under review; not available for automatic programming or exercise swaps.",libraryOnly:true,referenceOnly:true,automaticScheduling:false,videoUrl:null,videoSource:"",verifiedAt:null,verification:"No exact setup/playback verification completed. Demo unavailable."}));
