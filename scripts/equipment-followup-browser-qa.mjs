...
try {
 ...
 assert.equal(await page.getByRole('link',{name:'Short Demo: Tibialis raise',exact:true}).count(),0);
 await page.getByRole('link',{name:'Exercise guide: Tibialis raise',exact:true}).waitFor();
 ...
 pass('New research exercise exposes a guide and working enlarged illustration without claiming a verified demo');
